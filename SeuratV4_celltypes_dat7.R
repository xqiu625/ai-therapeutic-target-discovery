...
write.table(dat7_Tcell@meta.data,
            file = "/bigdata/godziklab/shared/Xinru/302005/datasets_v2/processed_datasets_v3/dat7_Tcell_annotation_SeuratV4.tsv",
            sep="\t")

dat7_Mono <- process7(df302004data17_Mono)
write.table(dat7_Mono@meta.data,
            file = "/bigdata/godziklab/shared/Xinru/302005/datasets_v2/processed_datasets_v3/dat7_Mono_annotation_SeuratV4.tsv",
            sep="\t")