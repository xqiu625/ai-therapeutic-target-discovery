...
setwd('/bigdata/godziklab/shared/Xinru/302005/datasets_v5/DC')
...
dpi = 300
png(file = "/bigdata/godziklab/shared/Xinru/302005/v5_output/Harmony/Harmony_convergence_Data_NO_DC.png", 
...
saveRDS(pbmc, '/bigdata/godziklab/shared/Xinru/302005/datasets_v5/harmony_int/302005_DC.rds')
...
saveRDS(pbmc, '/bigdata/godziklab/shared/Xinru/302005/datasets_v5/harmony_int/302005_DC_cluster.rds')
